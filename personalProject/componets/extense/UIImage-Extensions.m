...
//        NSLog(@"Resize image %.0fx%.0f -> (%.0f,%.0f)x(%.0f,%.0f) scale(%.0f) numPixels(%f)", self.size.width, self.size.height, 
...
+ (UIImage *)streWidthImageNamed:(NSString *)imageName
{
	if (imageName == nil) {
		return nil;
	}
...
// 6.3重复方法修改
//+ (UIImage *)streHeightImageNamed:(NSString *)imageName
//{
//    if (imageName == nil) {
//        return nil;
//    }
